        ...
        <div className="p-4">
          <ul className="space-y-3 text-gray-700">
            <li className="font-semibold">
              Nombre:{" "}
              <span className="font-light">{datos.nombre || <Skeleton />}</span>
            </li>
            <li className="font-semibold">
              Apellido:{" "}
            ...
            <li className="font-semibold">
              DNI:{" "}
              <span className="font-light">{datos.dni || <Skeleton />}</span>
            </li>
            <li className="font-semibold">
              Especialidad:{" "}
              <span className="font-light">
            ...
            <li className="font-semibold">
              Correo electrónico:{" "}
              <span className="font-light">{datos.email || <Skeleton />}</span>
            </li>
          </ul>
        </div>
